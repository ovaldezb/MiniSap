						...
						<table style="width:100%">
							...
							<thead>
								<tr style="background:LightSlateGray;">
									<td align="center" style="color:white" ng-click="orderByMe('CLAVE')">DOCUMENTO</td>
									<td align="center" style="color:white" ng-click="orderByMe('NOMBRE')">CLIENTE</td>
									<td align="center" style="color:white" ng-click="orderByMe('RFC')">FECHA PEDIDO</td>
									<td align="center" style="color:white" ng-click="orderByMe('CURP')">IMPORTE</td>
									<td align="center" style="color:white" ng-click="orderByMe('CURP')">VENDIDO</td>
								</tr>
							</thead>
						</table>
					</td>
				...
				<tr>
					<td>
						...
						<table class="table is-hoverable" style="width:100%" id="tblClientes">
							...
							<tr ng-repeat="x in lstPedidos | orderBy:myOrder:sortDir" ng-click="selectRowPedido(x.DOCUMENTO,$index)" ng-class="{selected: x.DOCUMENTO === idDocumento}">
								<td align="center">{{x.DOCUMENTO}}</td>
								<td align="center">{{x.CODIGO_CLIENTE}}</td>
		...
		<div class="columns is-gapless">
			<div class="column is-8">
				...
				<div class="box" id="compras">
					...
					<button class="button is-info is-rounded" ng-click="registraPedido()" id="regcompra">Registrar Pedido</button>
					<button class="button is-error is-rounded" ng-click="cancelaPedido()" >Cancelar</button>
				</div>
			</div>
