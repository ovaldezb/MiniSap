...
<div class="container" ng-controller="CtrlPagos" data-ng-init="init()">
  <div class="notification" >
	  <h1 class="title is-4 has-text-centered">Reporte de Pagos</h1>
	</div>
  ...
  <div class="table-container" ng-show="isRepShow" style="border:1px solid black;width:99%" id="exportable">
    <table class="table" style="width:100%" id="tblRepPagos">
      <colgroup>
        <col width="20%" >
        <col width="35%" >
        <col width="10%" >
