...
<div class="container" ng-app="myApp" ng-controller="myCtrlDatosFactura" data-ng-init="init()">
  <div class="notification">
		<h1 class="title has-text-centered is-4">Gestión de datos para Facturar</h1>
  </div>
        ...
        <form name="myForm" action='<?php echo base_url();?>datosfactura/save' enctype='multipart/form-data' method="post">
            ...
            <div class="columns">
                <div class="column is-2">
                  <label class="label">Archivo .cer</label>
                </div>
                <div class="column">
                  <input type="file" name="files[]" accept=".cer" select-ng-files ng-model="factura.cerFile">
                </div>            
            </div>
            <div class="columns">
