...
class Clientemodel extends CI_model
{
	...
	{
		$query = 'SELECT C."CLAVE",C."NOMBRE",C."DOMICILIO","CP","TELEFONO","CONTACTO","RFC","CURP",
		TC."DESCRIPCION" as "TIPO_CLIENTE","DIAS_CREDITO",
		DS1."NOMBRE" as "REVISION",
		DS2."NOMBRE"as "PAGOS",
		FP."DESCRIPCION" as "FORMA_PAGO",V."NOMBRE" as "VENDEDOR",UC."DESCRIPCION" as "CFDI",
